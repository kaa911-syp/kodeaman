...
export class MarkdownRenderer {
  renderPRComment(
    ...
    lines.push(
      locale === "id"
        ? "*Dibuat oleh [AspidaSec](https://github.com/aspidasec/aspidasec) — Security coach untuk developer Indonesia*"
        : "*Generated by [AspidaSec](https://github.com/aspidasec/aspidasec) — Security coach for Indonesian developers*",
    );
