...
export class MarkdownRenderer {
  renderPRComment(
    ...
    lines.push("## \u{1F6E1}\uFE0F KodeAman Security Report");
    lines.push("");
    ...
    lines.push(
      locale === "id"
        ? "*Dibuat oleh [KodeAman](https://github.com/kodeaman/kodeaman) — Security coach untuk developer Indonesia*"
        : "*Generated by [KodeAman](https://github.com/kodeaman/kodeaman) — Security coach for Indonesian developers*",
    );
  ...
  renderOwaspReport(
    ...
    lines.push("## KodeAman OWASP Top 10 Report");
    lines.push("");
